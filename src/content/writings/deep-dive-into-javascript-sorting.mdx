...
pubDate: "May 06 2025 00:00 +0530"
---

Have you read my **[Deep Dive into JavaScript Array Methods](/writings/deep-dive-into-javascript-array-methods/)**? In that post we used helpers like `map` and `reduce`.
...
- Go back to **[Functional Programming in JavaScript](/writings/functional-programming-in-javascript/)** and replace loops with `sort` plus `map` or `filter`.
