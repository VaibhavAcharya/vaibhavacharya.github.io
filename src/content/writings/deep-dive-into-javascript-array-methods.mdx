...
pubDate: "May 04 2025 00:00 +0530"
---

If you just read my **[Functional Programming in JavaScript](/writings/functional-programming-in-javascript/)** post, you saw a few helpful array methods like `map` and `reduce`.

Here, we'll slow down and take each helper apart, like opening a toy car to see the gears.

We'll even build our own versions from scratch — think of them as simple, [_pure_ functions](/writings/functional-programming-in-javascript/#2-pure-functions-the-smallest-reliable-unit) — to truly understand how they work under the hood.
...
- Revisit the **[Functional Programming in JavaScript](/writings/functional-programming-in-javascript/)** article to see these helpers in a wider context.
