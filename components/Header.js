  ...
  return (
    <div className="text-center">
      <h2 className="text-xl md:text-4xl mb-4">
        Hey 👋,<br />I am{" "}
        <span className="text-lightBlue-500 font-bold">Vaibhav Acharya</span>.
      </h2>
      <h1 className="text-2xl md:text-6xl mb-16">
        I design & <span className="underline">develop</span>{" "}
        <span className="bg-purple-500 text-white font-mono font-bold">websites</span>.
      </h1>
      <div className="flex items-center justify-center">
      <div className="flex items-center justify-start space-x-4">
        <button className="flex items-center justify-between space-x-2 bg-emerald-500 hover:bg-emerald-600 focus:outline-none focus-visible:bg-emerald-700 px-4 py-2 font-bold text-white">
