  ...
  return (
    <div className="pt-16">
      <h2 className="text-2xl md:text-4xl mb-2">
        Hey 👋, I am{" "}
        <span className="text-green-500 font-bold">Vaibhav Acharya</span>.
      </h2>
      <h1 className="text-4xl md:text-6xl">
        I design & <u>develop</u>{" "}
        <span className="text-lightBlue-500 font-bold">websites</span>.
      </h1>
      <br />
      <br />
      <div className="flex gap-x-4">
        <button className="bg-indigo-500 hover:bg-indigo-400 focus:outline-none focus-visible:bg-indigo-600 px-6 py-2 font-bold text-white">
          RESUME
        </button>
